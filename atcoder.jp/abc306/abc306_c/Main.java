...
public class Main {
  ...
  void solve() {
    ...
    for (int i = 0; i < second.length; i++) {
      ans.add(new Pair(second[i], i + 1));
    }
    ans.sort(Comparator.comparingInt(o -> o.key));
    String result = ans.stream().map(o -> String.valueOf(o.value)).collect(Collectors.joining(" "));
    out.println(result);
  }
