...
public class Main {
  ...
  void solve() {
    String[] s = in.nextStringArray(in.nextInt());
    Set<Stick> set = Arrays.stream(s).map(Stick::new).collect(Collectors.toSet());
...
class Stick {
  ...
  public boolean equals(Object o) {
    ...
    Stick stick = (Stick) o;
    if (Objects.equals(word, stick.word)) {
      return true;
    }

    if (Objects.equals(word, new StringBuilder(stick.word).reverse().toString())) {
      return true;
    }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(word) + Objects.hash(new StringBuilder(word).reverse().toString());
  }
}
